component extends="algid.inc.resource.base.event" {
	public void function afterHostedZoneCreate( required struct transport, required component currUser, required component hostedZone ) {
		// Add success message
	...
	public void function afterHostedZoneDelete( required struct transport, required component currUser, required component hostedZone ) {
		// Add success message
	...
	public void function afterResourceRecordSave( required struct transport, required component currUser, required component hostedZone ) {
		// Add success message
