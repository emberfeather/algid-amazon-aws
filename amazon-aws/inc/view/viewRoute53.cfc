					...
					<table class="datagrid">
						...
						<tbody>
							<cfloop array="#arguments.resourceRecords#" index="resourceRecord">
								<cfset isEditable = resourceRecord.getType() neq 'NS' && resourceRecord.getType() neq 'SOA' />
									...
									<cfif isEditable>
										<tr>
											<td class="col name column-0">
												<input type="text" name="resourceRecord_#counter#_name" value="#(structKeyExists(arguments.request, 'resourceRecord_#counter#_name') ? arguments.request['resourceRecord_#counter#_name'] : resourceRecord.getName())#" size="20" />
											</td>
											<td class="col ttl column-1">
												<input type="text" name="resourceRecord_#counter#_ttl" value="#(structKeyExists(arguments.request, 'resourceRecord_#counter#_ttl') ? arguments.request['resourceRecord_#counter#_ttl'] : resourceRecord.getTTL())#" size="5" />
											</td>
											...
											<td class="col value column-3">
												<input type="text" name="resourceRecord_#counter#_value" value="#(structKeyExists(arguments.request, 'resourceRecord_#counter#_name') ? arguments.request['resourceRecord_#counter#_name'] : record)#" size="70" />
											</td>
										</tr>
									<cfelse>
										<tr>
							...
							<cfloop from="1" to="10" index="i">
								<tr>
									<td class="col name column-0">
										<input name="resourceRecord_#counter#_name" value="#(structKeyExists(arguments.request, 'resourceRecord_#counter#_name') ? arguments.request['resourceRecord_#counter#_name'] : '')#" size="20" />
									</td>
									<td class="col ttl column-1">
										<input name="resourceRecord_#counter#_ttl" value="#(structKeyExists(arguments.request, 'resourceRecord_#counter#_ttl') ? arguments.request['resourceRecord_#counter#_ttl'] : '')#" size="5" />
									</td>
									<td class="col type column-2">
									...
									<td class="col value column-3">
										<input name="resourceRecord_#counter#_value" value="#(structKeyExists(arguments.request, 'resourceRecord_#counter#_value') ? arguments.request['resourceRecord_#counter#_value'] : '')#" size="70" />
									</td>
								</tr>
